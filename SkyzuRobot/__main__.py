...
EMI_IMG = "https://telegra.ph/file/7ba6536e75495cdc6ceb1.jpg"

DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support the project by contacting @nyagurl \
...
def start(update: Update, context: CallbackContext):
    ...
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_text(
            f"<b>Hi Onichan, I am Himawari UwU!</b>\n<b>Started working since:</b> <code>{uptime}</code>",
...
def Skyzu_about_callback(update, context):
    ...
    if query.data == "Skyzu_":
        query.message.edit_text(
            text="๏ I'm *Himawari*, a powerful group management bot built to help you manage your group easily."
            ...
            "\n\n_Himawari's licensed under the GNU General Public License v3.0_"
            "\n\n Click on button bellow to get basic help for HimawariRobot.",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        InlineKeyboardButton(
                            text="Support", callback_data="Skyzu_support"
                        ),
                        InlineKeyboardButton(
        ...
        query.message.edit_text(
            ...
            f"\n\nCongratulations, {dispatcher.bot.first_name} now ready to manage your group."
            "\n\n*Admin Tools*"
            ...
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton(text="🔙", callback_data="Skyzu_")]]
            ),
        )
        ...
        query.message.edit_text(
            text=f"*{dispatcher.bot.first_name} Support Tools*"
            "\n\nJoin My Support Group/Channel for see or report a problem on Hima.",
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
                [
                    [
        ...
        query.message.edit_text(
            text=f"<b>Credits for Himawari</b>\n"
            f"\nHere Developer Maintaining The HimawariRobot",
            parse_mode=ParseMode.HTML,
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(text="Arsh", url="t.me/nyagurl"),
                    ],
                    [
                        InlineKeyboardButton(text="🔙", callback_data="Skyzu_"),
                    ],
